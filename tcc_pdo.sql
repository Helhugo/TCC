...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02-Nov-2023 às 15:19
...
CREATE TABLE `carrinho` (
  `id_ProdCarrinho` int(11) NOT NULL,
  `prod_Carrinho` varchar(255) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `carrinho` (`id_ProdCarrinho`, `prod_Carrinho`, `user_Cliente`, `prod_Qtd`) VALUES
(11, 'Trufa de Oreo', 'Guigui', 1),
(13, 'Trufa de Chocomenta', 'Guigui', 3),
(14, 'Cone de Chocomenta', 'Guigui', 2);
...
(1, 'gui@gmail.com', 'Guilherme Gonçalvezs', 'Guigui', 'Captura de tela 2023-06-30 155048.png', '23', '2023-06-05', '15998097856'),
(2, 'feijaoprato@gmail.com', 'feijaoprato', 'feijaozin', 'trunhan.png', '23434', '0000-00-00', '234234'),
(11, 'asda@adsd', 'dsd', 'sdsd', '', '1321', '1232-12-13', '0'),
(12, 'ads@ed', 'adassssssssssssssssssssssss', 'asda', 'aa.jpg', '111', '2023-10-16', '1313');
...
ALTER TABLE `carrinho`
  ADD PRIMARY KEY (`id_ProdCarrinho`);
...
--
ALTER TABLE `carrinho`
  MODIFY `id_ProdCarrinho` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `favoritos`
  MODIFY `id_Favorito` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
